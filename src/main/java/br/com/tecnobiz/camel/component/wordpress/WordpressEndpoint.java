...
public class WordpressEndpoint extends DefaultEndpoint {
    ...
    @UriPath(description = "The endpoint method. Currently, only the 'post' method is supported.", enums = "br.com.tecnobiz.camel.component.wordpress.WordpressMethodType")
